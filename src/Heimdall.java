...
import static training_data.BasicDataSets.or5_inputs;
import static training_data.BasicDataSets.or5_outputs;
...
//		}
		...
		Trainer trainer = new Trainer(
				...
				new int[] {  // layers format
						...
						10, // number of middle layer nodes, more opportunities per agent to learn
						2  // output layer is number of possible answers (0.0-1.0 inclusive)
				}
		);
		trainer.train(
				inputs,
